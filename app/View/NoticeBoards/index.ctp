...
<div class="noticeBoards index">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $noticeBoard['NoticeBoard']['title']; ?>&nbsp;</td>
		<td><?php echo substr($noticeBoard['NoticeBoard']['description'],0,100); ?>&nbsp;</td>
		
		<td><?php echo $noticeBoard['NoticeBoard']['active']; ?>&nbsp;</td>
		<td><?php echo $noticeBoard['NoticeBoard']['created']; ?>&nbsp;</td>
		<td><?php echo $noticeBoard['NoticeBoard']['modified']; ?>&nbsp;</td>
