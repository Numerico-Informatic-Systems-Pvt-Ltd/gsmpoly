<div class="blogs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('blog_comment_count');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $blog['Blog']['tags']; ?>&nbsp;</td>
		<td><?php echo $blog['Blog']['blog_comment_count']; ?>&nbsp;</td>
		<td><?php echo $blog['Blog']['active']; ?>&nbsp;</td>
