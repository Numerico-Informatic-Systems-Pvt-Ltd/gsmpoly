 ...
 */
	...
	public function sidebar_content($slug = null) {
		...
		$options = array('conditions' => array('Content.' . $this->Content->primaryKey => $id));
		return $this->Content->find('first', $options);
 ...
 */
	public function add() {
		if ($this->request->is('post')) {
			$this->request->data['Content']['user_id'] = 
		...
		$menus = $this->Content->Menu->find('list');
		$layouts = $this->Content->Layout->find('list');
		$this->set(compact('users', 'menus', 'layouts'));
	}
